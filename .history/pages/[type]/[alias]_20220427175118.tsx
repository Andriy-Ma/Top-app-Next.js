...
import { TopLevelCategory, TopPageModel } from "../../intefaces/toppage.interface";
...
export const getStaticPaths: GetStaticPaths = async () => {
    ...
    for ( const s of firstLevelMenu){
      const {data: menu} = await axios.post<MenuItem[]>(process.env.NEXT_PUBLIC_DOMAIN + '/api/top-page/find', {firstCategory: s.id});
